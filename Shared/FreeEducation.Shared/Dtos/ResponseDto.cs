...
namespace FreeEducation.Shared.Dtos
{
    public class ResponseDto<T>
    {
        ...
        public static ResponseDto<T> Success(T data, int statusCode) { return new ResponseDto<T> { Data = data, StatusCode = statusCode, isSuccessful = true }; }
